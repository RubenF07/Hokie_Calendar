...
public class DayTest extends TestCase
{
    ...
    public void setUp()
    {
        ...
        timedFirst = new TimedEvent("Yoga", "Gym", true, new Time(11, 30, true), new Time(1, 30, false));
        timedSecond = new TimedEvent("Birthday", "Home", true, new Time(5, 30, false), new Time(7, 45, false));
        today = new Day(22);
    }
    ...
    public void testAddEvent()
    {
        ...
        assertEquals("Yoga at Gym from 11:30-1:30\nBirthday at Home from 5:30-7:45\nAll Day at Here\n", today.toString());
    }
}
